...
> **v1.0 достигнут (2026-09-01):** G10 (G10.1–G10.7) готов ✅. Фокус — **UI-V2** (`docs/FRONTEND-UI-V2.md`): фундаментальная и богатая доработка интерфейса (UI-1 → UI-5). Затем G11/G12 (харденинг) → G8/G9 (AI-глубина).
